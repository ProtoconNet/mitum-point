...
var ApproveItemHint = hint.MustNewHint("mitum-point-approve-item-v0.0.1")
...
func NewApproveItem(
	contract base.Address, approved base.Address, amount common.Big, currency types.CurrencyID) ApproveItem {
	return ApproveItem{
	...
	if !it.amount.OverNil() {
		return common.ErrFactInvalid.Wrap(
			common.ErrValOOR.Wrap(
				errors.Errorf("approve amount must be greater than or equal to zero, got %v", it.amount)))
	}
