...
var (
	TransfersFromFactHint = hint.MustNewHint("mitum-point-transfers-from-operation-fact-v0.0.1")
	TransfersFromHint     = hint.MustNewHint("mitum-point-transfers-from-operation-v0.0.1")
)
