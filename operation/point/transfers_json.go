...
type TransfersFactJSONMarshaler struct {
...
func (fact TransfersFact) MarshalJSON() ([]byte, error) {
	return util.MarshalJSON(TransfersFactJSONMarshaler{
...
func (fact *TransfersFact) DecodeJSON(b []byte, enc encoder.Encoder) error {
	var u TransfersFactJSONUnmarshaler
...
func (op *Transfers) DecodeJSON(b []byte, enc encoder.Encoder) error {
