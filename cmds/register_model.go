...
type RegisterPointCommand struct {
	...
	Decimal       ccmds.BigFlag   `arg:"" name:"decimal" help:"decimal of point" required:"true"`
	InitialSupply ccmds.BigFlag   `arg:"" name:"initial-supply" help:"initial supply of point" required:"true"`
}
